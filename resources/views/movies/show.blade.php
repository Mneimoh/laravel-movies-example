				...
				<div x-data="{ isOpen:false }">
					...
					@if(count($movie['videos']['results']) > 0)
						<div class="mt-12">
							<button 
								@click = "isOpen = true"
								href="https://youtube.com/watch?v={{ $movie['videos']['results'][0]['key'] }}" class="flex inline-flex items-center bg-yellow-700 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-yellow-800 transition ease-in-out duration-150">
